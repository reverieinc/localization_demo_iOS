...
#ifndef LOCALIZATION_DEMO_SWIFT_H
#define LOCALIZATION_DEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="localization_demo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17localization_demo11AppDelegate")
...
SWIFT_CLASS("_TtC17localization_demo19FirstViewController")
@interface FirstViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified lang_option_button;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified first_page_content;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC17localization_demo13SceneDelegate")
...
SWIFT_CLASS("_TtC17localization_demo20SecondViewController")
@interface SecondViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)onPreviousButtonClicked:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC17localization_demo14ViewController")
